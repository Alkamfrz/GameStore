      ...
      >
        ...
        <div class="space-x-5 select-none">
          ...
          <div class="dropdown inline-block relative">
            <button class="text-gray-500 text-lg inline-flex items-center p-2 rounded hover:bg-gray-200">
              <i class="fas fa-user"></i>
            </button>
            <div class="dropdown-menu absolute right-0 hidden text-gray-700 pt-1 bg-white w-32 shadow-lg rounded">
              <p class="rounded-t py-2 px-4 block whitespace-no-wrap border-b border-gray-200">Hello, ${username}</p>
              <a class="py-2 px-4 block whitespace-no-wrap hover:bg-gray-100" href="#">Profile</a>
              <a class="rounded-b py-2 px-4 block whitespace-no-wrap hover:bg-gray-100" href="/GameStore/logout">Logout</a>
            </div>
          </div>
        </div>
      </div>
